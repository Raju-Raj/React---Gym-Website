  ...
  return (
    <div className='header'>
       ...
       >
        ...
        <li >
          <Link onClick={()=>setMenuOpened(false)} to="home" span={true} smooth={true} activeClass="active">Home</Link>
        </li>
        <li >
        ...
        <li >
        <Link onClick={()=>setMenuOpened(false)} to="testimonials" span={true} smooth={true}>Testmonials</Link>
        </li>
      </ul>
       )}
